...
import com.example.review.global.log.util.LogUtils;
...
//    private String baseUrl;
    ...
    public ResponseEntity<ErrorResponse> handleApplicationException(ReviewException exception) {
    ...
    @ExceptionHandler(ReviewSecurityException.class)
    public ResponseEntity<ErrorResponse> handleApplicationException(ReviewSecurityException exception) {
        LogUtils.warn(exception);
