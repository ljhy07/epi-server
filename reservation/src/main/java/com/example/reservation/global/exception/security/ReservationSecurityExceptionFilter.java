...
import com.example.reservation.global.exception.ErrorResponse;
...
public class ReservationSecurityExceptionFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        } catch (ReservationSecurityException e) {
    ...
    private void handleUserSecurityException(HttpServletResponse response, ReservationSecurityException e) throws IOException {
