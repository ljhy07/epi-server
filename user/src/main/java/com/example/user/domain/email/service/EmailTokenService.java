...
import com.example.user.domain.email.domain.repository.EmailRepository;
import com.example.user.domain.email.exception.EmailTokenAlreadyVerifiedException;
import com.example.user.domain.email.exception.EmailTokenNotFoundException;
import com.example.user.domain.email.exception.ExpiredEmailTokenException;
...
import com.example.user.domain.user.exception.UserExistedException;
