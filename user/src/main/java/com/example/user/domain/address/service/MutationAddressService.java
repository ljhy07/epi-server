package com.example.user.domain.address.service;

import com.example.user.domain.address.domain.Address;
import com.example.user.domain.address.presentation.dto.req.CreateAddressInput;
import com.example.user.domain.address.presentation.dto.req.DeleteAddressInput;
import com.example.user.domain.address.presentation.dto.req.UpdateAddressInput;
import com.example.user.domain.address.presentation.dto.res.AddressResponse;
import com.example.user.domain.address.service.implementation.AddressCreator;
import com.example.user.domain.address.service.implementation.AddressDeleter;
import com.example.user.domain.address.service.implementation.AddressReader;
import com.example.user.domain.address.service.implementation.AddressUpdater;
