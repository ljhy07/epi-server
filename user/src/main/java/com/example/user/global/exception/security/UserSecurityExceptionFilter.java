...
import com.example.user.global.exception.ErrorResponse;
...
public class UserSecurityExceptionFilter extends OncePerRequestFilter {
    ...
    private void handleUserSecurityException(HttpServletResponse response, UserSecurityException e) throws IOException {
